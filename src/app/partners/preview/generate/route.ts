...
import { requireAdminDev } from '@/app/lib/adminAuth' // Using dev version for testing

export async function POST(request: Request) {
  try {
    // Check admin permissions first
    try {
      await requireAdminDev() // Use this for testing, change to requireAdmin() in production
    } catch (error) {
