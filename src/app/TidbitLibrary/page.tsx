      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100">
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center py-20" role="alert">
            ...
            <a href="/TidbitLibrary" className="inline-block px-6 py-3 bg-brand-green text-white rounded-xl hover:bg-green-600 transition-colors focus:ring-2 focus:ring-brand-green/20 focus:outline-none">
              Refresh Page
            </a>
          </div>
        </main>
