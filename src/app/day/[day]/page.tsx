...
import { Clock, Star, Tag, Play, Users, ArrowRight, CheckCircle, Lightbulb, Target, Camera, Share2, Loader2 } from 'lucide-react'
...
const SocialShare = ({ tidbit }: { tidbit: any }) => {
  ...
  if (!mounted) {
    return (
      <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-emerald-200/50 shadow-lg">
        <div className="text-center">
          <Loader2 className="h-6 w-6 animate-spin mx-auto text-brand-green" />
          <p className="body-medium text-gray-600 mt-2">Loading sharing options...</p>
        </div>
      </div>
    )
  }
  ...
  const copyToClipboard = async () => {
    try {
      ...
      // Keep the alert for error cases
        ...
        {shareOptions.map(option => (
          <button
            ...
            className="
              ...
              hover:scale-105
              focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-brand-green
            "
            style={{
        ...
        <button
          ...
          className={`
            ...
            ${copySuccess 
              ...
              : 'bg-brand-green hover:bg-brand-green-dark border-brand-green hover:border-brand-green-dark'
            }
            text-white
            rounded-lg shadow-sm hover:shadow-md
            transition-all duration-200
            ${!copySuccess && 'hover:scale-105'}
            focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-brand-green
          `}
