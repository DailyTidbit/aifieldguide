          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-[#60A875] rounded-full flex items-center justify-center">
                  <Shield className="w-8 h-8 text-white" />
                </div>
              </div>
              <h1 
                className="text-4xl md:text-5xl font-bold text-[#60A875] mb-4"
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 md:p-12">
              ...
              >
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">1. INFORMATION WE COLLECT</h2>
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Information from Third-Party Sources</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">D. AI-Generated and Enhanced Data</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">E. Sensitive Personal Information</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">2. HOW WE USE YOUR INFORMATION</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. Service Provision and Account Management</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Content and Experience Enhancement</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Analytics, Performance, and Site Improvement</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">D. Marketing and Communications</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">E. Safety, Security, and Legal Compliance</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">F. Affiliate and Sponsor Operations</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">3. LEGAL BASES FOR PROCESSING (EEA/UK/International Users)</h2>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">4. HOW WE SHARE YOUR INFORMATION</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. We DO NOT Sell Personal Information</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  Daily Tidbit does not sell, rent, or trade personal information to third parties for their marketing purposes.
                </p>

                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Service Providers and Processors</h3>
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Public User Content</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">D. Affiliate and Sponsor Partners</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">E. Legal Requirements and Safety</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">F. Business Transfers</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">G. Aggregated and Anonymized Data</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">5. USER-GENERATED CONTENT AND PUBLIC INFORMATION</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. Public vs. Private Content</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Content Removal and Persistence</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Staff Access to Private Content</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">6. COOKIES AND TRACKING TECHNOLOGIES</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. Types of Cookies We Use</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Third-Party Analytics</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Your Cookie Choices</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">7. DATA RETENTION</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. Account and Profile Data</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Content Data</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Usage and Analytics Data</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">D. Communications</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">E. Legal and Compliance</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  We may retain information longer when required for legal compliance, dispute resolution, or enforcement of our agreements.
                </p>

                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">F. Indefinite Retention for Legal Protection</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">8. DATA SECURITY</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. Security Measures</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Security Limitations</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Your Security Responsibilities</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">D. Limitation of Liability for Data Issues</h3>
                <p className="text-gray-700 leading-relaxed mb-6 font-bold">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">9. INTERNATIONAL DATA TRANSFERS</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. US-Based Operations</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Safeguards for International Transfers</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. EEA/UK User Rights</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  EEA and UK users retain all rights under GDPR/UK GDPR regardless of data transfer location.
                </p>

                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">10. YOUR RIGHTS AND CHOICES</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. Account Access and Control</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Data Rights (All Users)</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Communication Preferences</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">D. State-Specific Rights (US)</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">E. EEA/UK/International Rights (GDPR)</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">F. Exercising Your Rights</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Contact us at: mike@dailytidbit.org or Daily Tidbit LLC, Privacy Rights, 4 S Edlin St Worcester MA 01603
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  We will:
                </p>
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">11. CHILDREN'S PRIVACY</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. Age Restrictions</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  Our Site is not directed to children under 13. We do not knowingly collect personal information from children under 13.
                </p>

                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. COPPA Compliance</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  If we discover we have collected information from a child under 13 without parental consent, we will promptly delete it.
                </p>

                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Minors (13-17)</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">D. Parental Action</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  If you believe your child under 13 has provided information to us, contact us immediately at mike@dailytidbit.org.
                </p>

                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">12. THIRD-PARTY LINKS AND INTEGRATIONS</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. External Links</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Third-Party Services</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Affiliate and Sponsor Links</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">13. ADDITIONAL DISCLOSURES</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. AI and Automated Decision-Making</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Marketing and Advertising</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Data Sharing Transparency</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">14. COMPLIANCE AND REGULATORY INFORMATION</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. Privacy Frameworks</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Data Processing Agreements</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  We maintain appropriate data processing agreements with all service providers who handle personal data on our behalf.
                </p>

                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Privacy Impact Assessments</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  We conduct privacy impact assessments for high-risk data processing activities as required by applicable law.
                </p>

                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">15. CONTACT INFORMATION AND COMPLAINTS</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. Privacy Contact</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  For privacy questions, requests, or complaints:
                </p>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                  <li><strong>Email:</strong> mike@dailytidbit.org (Subject: Privacy Inquiry)</li>
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Data Protection Officer</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  For EEA/UK users or complex privacy matters, you may request to speak with our privacy compliance team.
                </p>

                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">C. Regulatory Complaints</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">16. POLICY UPDATES AND NOTIFICATIONS</h2>
                
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">A. Change Process</h3>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">B. Version History</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  We maintain records of policy versions and can provide information about changes upon request.
                </p>

                <h2 className="text-2xl font-bold text-[#60A875] mt-8 mb-4">17. DISPUTE RESOLUTION AND ARBITRATION</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  For disputes specifically related to privacy or data handling, you may opt out of arbitration by emailing mike@dailytidbit.org with "Privacy Arbitration Opt-Out" in the subject line within 30 days of first accepting this Privacy Policy.
                </p>
