            ...
            {listItems.map((item, i) => {
              ...
              return (
                <li key={`item-${i}`} className="flex items-start gap-3">
                  <span className="flex items-center justify-center w-6 h-6 bg-[#60A875] text-white rounded-full text-sm font-bold flex-shrink-0 mt-0.5">
                    {number}
                  </span>
            ...
            {listItems.map((item, i) => {
              ...
              return (
                <li key={`bullet-${i}`} className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#59B1E3] rounded-full flex-shrink-0 mt-2"></div>
                  <span className="text-gray-700 leading-relaxed">
                    {formatInlineText(cleanItem)}
                  </span>
                </li>
