              ...
              <div className="max-w-md mx-auto">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:border-current bg-white shadow-sm transition-all ${colorClasses.text}`}
