    ...
    >
          ...
          return (
            <Link
              ...
              className="group relative rounded-2xl border border-black/[0.06] bg-white shadow-sm transition-all
                         ...
                         focus:ring-2 focus:ring-[#60A875]/20"
            ...
            >
              ...
              <div className="p-5 md:p-6">
                ...
                {/* Explore affordance */}
                <div className="mt-3 inline-flex items-center text-sm font-semibold text-[#60A875]">
      ...
      <div className="mt-8 md:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
        <Link
          ...
          className="inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-semibold bg-[#60A875] text-white shadow hover:opacity-95 transition"
        >
