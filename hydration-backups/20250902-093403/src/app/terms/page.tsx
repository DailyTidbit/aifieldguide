...
export const metadata: Metadata = {
  title: 'Terms & Conditions | Daily Tidbit',
  description: 'Terms and conditions for using Daily Tidbit, including community guidelines, privacy policies, and user agreements.',
  openGraph: {
    title: 'Terms & Conditions | Daily Tidbit',
    description: 'Terms and conditions for using Daily Tidbit platform',
    type: 'website',
  },
}
        ...
        <section className="py-12 sm:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="heading-hero text-brand-orange mb-4">
                Terms & Conditions
              </h1>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <div className="prose prose-lg max-w-none">
                <h2 className="heading-section text-brand-orange mt-8 mb-4">1. ACCEPTANCE OF TERMS AND BINDING ARBITRATION NOTICE</h2>
                
                <p className="body-large text-gray-700 leading-relaxed mb-4 body-bold">
                ...
                <h2 className="heading-section text-brand-orange mt-8 mb-4">2. DEFINITIONS AND SCOPE</h2>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h2 className="heading-section text-brand-orange mt-8 mb-4">3. USER CONTENT AND INTELLECTUAL PROPERTY RIGHTS</h2>
                
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">A. Comprehensive License Grant</h3>
                <p className="body-medium text-gray-600 leading-relaxed mb-4 italic">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">B. Content Ownership and Moral Rights Waiver</h3>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">C. User Content Representations and Warranties</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-4">You represent and warrant that:</p>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h2 className="heading-section text-brand-orange mt-8 mb-4">4. COMPREHENSIVE COMMUNITY GUIDELINES AND PROHIBITED CONDUCT</h2>
                
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">A. Prohibited Content (Zero Tolerance)</h3>
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    <p className="body-bold text-gray-800">1. Hate Speech, Harassment, and Discrimination:</p>
                    <ul className="list-disc list-inside body-large text-gray-700 ml-4 space-y-1">
                  ...
                  <div>
                    <p className="body-bold text-gray-800">2. Violent and Harmful Content:</p>
                    <ul className="list-disc list-inside body-large text-gray-700 ml-4 space-y-1">
                  ...
                  <div>
                    <p className="body-bold text-gray-800">3. Sexual and Adult Content:</p>
                    <ul className="list-disc list-inside body-large text-gray-700 ml-4 space-y-1">
                  ...
                  <div>
                    <p className="body-bold text-gray-800">4. Illegal Activities and Fraud:</p>
                    <ul className="list-disc list-inside body-large text-gray-700 ml-4 space-y-1">
                  ...
                  <div>
                    <p className="body-bold text-gray-800">5. Intellectual Property Violations:</p>
                    <ul className="list-disc list-inside body-large text-gray-700 ml-4 space-y-1">
                  ...
                  <div>
                    <p className="body-bold text-gray-800">6. Misinformation and Harmful False Information:</p>
                    <ul className="list-disc list-inside body-large text-gray-700 ml-4 space-y-1">
                  ...
                  <div>
                    <p className="body-bold text-gray-800">7. Spam and Commercial Violations:</p>
                    <ul className="list-disc list-inside body-large text-gray-700 ml-4 space-y-1">
                  ...
                  <div>
                    <p className="body-bold text-gray-800">8. Privacy Violations:</p>
                    <ul className="list-disc list-inside body-large text-gray-700 ml-4 space-y-1">
                  ...
                  <div>
                    <p className="body-bold text-gray-800">9. Platform Manipulation:</p>
                    <ul className="list-disc list-inside body-large text-gray-700 ml-4 space-y-1">
                  ...
                  <div>
                    <p className="body-bold text-gray-800">10. Technical Violations:</p>
                    <ul className="list-disc list-inside body-large text-gray-700 ml-4 space-y-1">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">B. Social Media Specific Prohibitions</h3>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">C. Enforcement and Sanctions</h3>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h2 className="heading-section text-brand-orange mt-8 mb-4">5. SPONSORED CONTENT, AFFILIATE RELATIONSHIPS, AND MONETIZATION</h2>
                
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">A. Sponsored Content</h3>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">B. Affiliate Relationships</h3>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">C. Promotional Codes and Offers</h3>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">D. Revenue Model and Additional Transparency</h3>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h2 className="heading-section text-brand-orange mt-8 mb-4">6. SOCIAL MEDIA FEATURES AND INTERACTIONS</h2>
                
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">A. Social Features Disclaimer</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">B. User Interactions</h3>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">C. Social Feature Modifications</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  We may modify, suspend, or discontinue any social features at any time without notice or liability.
                </p>

                <h2 className="heading-section text-brand-orange mt-8 mb-4">7. EXTREME LIMITATION OF LIABILITY</h2>
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">D. Essential Purpose</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                ...
                <h2 className="heading-section text-brand-orange mt-8 mb-4">8. COMPREHENSIVE INDEMNIFICATION</h2>
                <p className="body-large text-gray-700 leading-relaxed mb-4">
                ...
                <h2 className="heading-section text-brand-orange mt-8 mb-4">9. BINDING ARBITRATION AND CLASS ACTION WAIVER</h2>
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">F. Severability</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  If any part of this arbitration clause is found unenforceable, the remainder remains in effect.
                </p>

                <h2 className="heading-section text-brand-orange mt-8 mb-4">10. AI CONTENT AND PROFESSIONAL ADVICE DISCLAIMERS</h2>
                
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">A. AI Content Warning</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6 body-bold">
                ...
                <h2 className="heading-section text-brand-orange mt-8 mb-4">11. MAXIMUM WARRANTY DISCLAIMERS</h2>
                
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">A. "AS IS" Provision</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">B. Third-Party Content</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  We disclaim all responsibility for third-party content, including User Content, advertisements, and linked websites.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">C. AI and Automated Systems</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  We make no warranties regarding AI-generated content, automated systems, or algorithmic recommendations.
                </p>

                <h2 className="heading-section text-brand-orange mt-8 mb-4">12. ACCOUNT TERMINATION AND SITE MODIFICATIONS</h2>
                
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">A. Termination Rights</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">B. Effect of Termination</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-4">
                  Upon termination:
                </p>
                <ul className="list-disc list-inside body-large text-gray-700 mb-6 space-y-2">
                ...
                <h2 className="heading-section text-brand-orange mt-8 mb-4">13. DMCA AND IP COMPLIANCE</h2>
                
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">A. Copyright Policy</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  We respond to proper DMCA takedown notices sent to: <a href="mailto:mike@dailytidbit.org" className="text-brand-blue hover:text-blue-700 underline underline-offset-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue focus-visible:ring-offset-2">mike@dailytidbit.org</a>
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">B. Repeat Infringer Policy</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  Accounts of repeat infringers will be terminated.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">C. Counter-Notifications</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  Users may submit counter-notifications following DMCA procedures.
                </p>

                <h2 className="heading-section text-brand-orange mt-8 mb-4">14. INTERNATIONAL USE AND EXPORT CONTROL</h2>
                
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">A. Global Access</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  The Site is controlled from the United States but accessible worldwide.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">B. Export Compliance</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  You agree not to use the Site in violation of U.S. export control laws.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">C. Local Law Compliance</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  You are responsible for compliance with all applicable local laws.
                </p>

                <h2 className="heading-section text-brand-orange mt-8 mb-4">15. FORCE MAJEURE AND UNAVOIDABLE CIRCUMSTANCES</h2>
                <p className="body-large text-gray-700 leading-relaxed mb-4">
                ...
                <h2 className="heading-section text-brand-orange mt-8 mb-4">16. ADDITIONAL PROTECTIONS AND MISCELLANEOUS</h2>
                
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">A. Entire Agreement</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  These Terms, together with our Privacy Policy, constitute the entire agreement and supersede all prior agreements.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">B. Governing Law</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  These Terms are governed by Massachusetts law, excluding conflict of law principles.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">C. Severability</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  If any provision is unenforceable, the remainder remains in full effect.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">D. No Waiver</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  Our failure to enforce any provision does not waive our right to do so later.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">E. Assignment</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  We may assign these Terms without notice. You may not assign your rights without our written consent.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">F. Survival</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                ...
                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">G. Electronic Communications</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  You consent to receive communications electronically and agree such communications satisfy legal requirements.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">H. No Third-Party Beneficiaries</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  These Terms create no third-party beneficiary rights.
                </p>

                <h3 className="heading-subsection text-gray-800 mt-6 mb-3">I. Headings</h3>
                <p className="body-large text-gray-700 leading-relaxed mb-6">
                  Section headings are for convenience only and do not affect interpretation.
                </p>

                <h2 className="heading-section text-brand-orange mt-8 mb-4">17. CONTACT INFORMATION</h2>
                <p className="body-large text-gray-700 leading-relaxed mb-2">
                  <strong>Daily Tidbit LLC</strong>
                </p>
                <p className="body-large text-gray-700 leading-relaxed mb-2">
                  <strong>Email:</strong> <a href="mailto:mike@dailytidbit.org?subject=Terms%20and%20Conditions" className="text-brand-orange hover:text-orange-600 underline underline-offset-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange focus-visible:ring-offset-2">mike@dailytidbit.org</a>
                </p>
                <p className="body-large text-gray-700 leading-relaxed mb-2">
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="flex items-center gap-3 text-gray-600 body-large">
                  ...
                  <a 
                    ...
                    className="text-brand-orange hover:text-orange-600 transition-colors underline underline-offset-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange focus-visible:ring-offset-2"
                  >
