  ...
  return (
    ...
    >
      <head>
        ...
        {/* Theme colors with dark mode support - USING BRAND COLORS */}
        <meta name="theme-color" content="brand-green" />
        <meta name="theme-color" media="(prefers-color-scheme: dark)" content="brand-green" />
        
        {/* Microsoft specific - FIXED to match your actual files */}
        <meta name="msapplication-TileColor" content="brand-green" />
        <meta name="msapplication-TileImage" content="/192.png" />
        <meta name="msapplication-config" content="/browserconfig.xml" />
        
        {/* Safari specific - USING BRAND GREEN */}
        <link rel="mask-icon" href="/96.png" color="brand-green" />
      ...
      <body className="antialiased min-h-screen bg-white flex flex-col font-sans" suppressHydrationWarning>
        {/* Skip to main content link - USING BRAND COLORS */}
        <a
          href="#main-content"
        ...
        {/* Service Worker registration for PWA - FIXED for hydration safety */}
