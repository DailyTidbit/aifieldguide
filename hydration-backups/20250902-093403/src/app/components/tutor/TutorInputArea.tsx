  ...
  return (
    <div className="space-y-3 mb-4">
      <div className="flex items-center gap-2 text-xs text-gray-600">
        ...
        {currentProvider.free && <span className="text-brand-greenDark">• Free</span>}
      </div>
      ...
      <div className="relative">
        <textarea
          ...
          rows={6}
          className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue transition-all duration-200 disabled:bg-gray-100 disabled:cursor-not-allowed resize-none text-base leading-relaxed"
      ...
      <div className="flex justify-end">
        <button
          ...
          className="bg-brand-blue text-white px-8 py-3 rounded-xl hover:bg-brand-blueDark transition-all duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-md hover:shadow-lg transform hover:scale-105"
        >
