                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[brand-green] focus:border-[brand-green] text-lg" 
              ...
              <div className="flex flex-col items-center space-y-6">
                <div className="relative">
                  ...
                  <button 
                    ...
                    className="absolute bottom-0 right-0 p-3 bg-[brand-green] text-white rounded-full shadow-lg hover:bg-brand-greenDark transition-colors" 
                ...
                <button 
                  onClick={() => fileInputRef.current?.click()} 
                  className="flex items-center gap-3 px-6 py-3 border-2 border-dashed border-gray-300 rounded-lg hover:border-[brand-green] hover:bg-green-50 transition-colors" 
                  disabled={uploadingAvatar}
                >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[brand-green] focus:border-[brand-green]" 
        ...
        <div className="p-6 border-t border-gray-200 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2 bg-[brand-green] text-white rounded-lg hover:bg-brand-greenDark disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {loading ? (
                <>
