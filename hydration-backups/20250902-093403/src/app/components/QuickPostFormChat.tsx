...
import { Users, Send, Sparkles, X } from 'lucide-react'
...
export default function QuickPostFromChat({
  ...
  if (!user) {
    return (
      <div className="bg-gradient-to-r from-[brand-blue]/10 to-[brand-green]/10 rounded-xl p-6 border border-[brand-blue]/20 text-center">
        <div className="flex items-center justify-center w-12 h-12 bg-[brand-blue] rounded-full mx-auto mb-3">
        ...
        <button className="px-6 py-2 bg-[brand-green] text-white rounded-lg hover:bg-brand-greenDark transition-colors font-medium">
          Sign In to Share
        </button>
      </div>
    )
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-[brand-green] text-white rounded-lg hover:bg-brand-greenDark transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {posting ? (
                <>
    ...
    <div className="bg-gradient-to-r from-[brand-blue]/10 to-[brand-green]/10 rounded-xl p-6 border border-[brand-blue]/20">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          ...
          disabled={posting}
          className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-[brand-blue] text-white rounded-lg hover:bg-brand-blueDark transition-colors disabled:opacity-50 font-medium"
        >
          {posting ? (
            <>
              <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
        ...
        <button
          ...
          className="px-4 py-3 border border-[brand-green] text-[brand-green] rounded-lg hover:bg-[brand-green] hover:text-white transition-colors font-medium"
        >
          Customize
        </button>
