          ...
          <div className="text-center">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-4">
              ...
              <Link
                ...
                className="cursor-pointer block rounded-xl bg-[brand-green] text-white px-6 py-5 shadow-lg transition-all duration-300 hover:bg-brand-greenDark hover:scale-105 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[brand-green] group min-h-[120px]"
              >
              ...
              <Link
                ...
                className="cursor-pointer block rounded-xl bg-[brand-blue] text-white px-6 py-5 shadow-lg transition-all duration-300 hover:bg-brand-blueDark hover:scale-105 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[brand-blue] group min-h-[120px]"
              >
                <div className="flex flex-col items-center justify-center gap-2 font-semibold">
                  <div className="text-3xl mb-1 group-hover:scale-110 group-hover:animate-pulse transition-all duration-300 drop-shadow-sm">??</div>
